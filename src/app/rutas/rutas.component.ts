...
directionsDisplay = new google.maps.DirectionsRenderer()
  ...
  crearRuta(){
    ...
    if(num.value!=""){
      ...
      alert("Es necesario poner el numero de empleado");
    }
  ...
  guardar(){
    if(this.numRastreo!=""){
      ...
      this.con.guardarEnRuta(this.numRastreo,this.markern.position,this.idRuta).subscribe(
        datos=>{
          if(datos['resultado']=="OK"){
            alert("guardado exitoso");
            this.markern=null;
            window.print();
            (<HTMLInputElement>document.getElementById("calle")).value = "";
            (<HTMLInputElement>document.getElementById("numeroExterior")).value ="";
            (<HTMLInputElement>document.getElementById("colonia")).value = "";
            (<HTMLInputElement>document.getElementById("calle2")).value = "";
            (<HTMLInputElement>document.getElementById("numeroExterior2")).value = "";
            (<HTMLInputElement>document.getElementById("colonia2")).value = "";
            var a=<HTMLImageElement>document.getElementById("imagen");
            a.src="";
            this.numRastreo="";
      ...
      alert("Es necesario marcar un destino");
    }
    }else{
      alert("Es necesario poner el codigo de rastreo");
    }
